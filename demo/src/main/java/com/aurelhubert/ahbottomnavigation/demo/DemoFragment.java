...
public class DemoFragment extends Fragment {
	...
	private void initDemoSettings(View view) {
		...
		for (BottomNavigation.TitleState titleState : BottomNavigation.TitleState.values()) {
		...
		spinnerTitleState.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
			...
			public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
				BottomNavigation.TitleState titleState = BottomNavigation.TitleState.valueOf(titleStates.get(position));
